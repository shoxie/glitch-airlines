...
exports.exec = async (Bastion, message, args) => {
 ...
 /*let msg = message.content.toUpperCase();
    //if((message.channel.id === guild.musicTextChannel.id) &&(msg.startsWith('.'))) 
    if(message.channel.id === musicTextChannel.id || msg.startsWith('.')) {
      return;
    } else if(message.channel.id === musicTextChannel.id || !msg.startsWith('.')){
      message.delete();
    }*/
