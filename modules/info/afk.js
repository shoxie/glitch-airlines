...
exports.help = {
  name: 'afk',
  description: 'Sets you as Away From Keyboard (AFK). So when someone mentions you, I will let them know that you\'re AFK. It\'ll be automatically disabled once you are back.',
  botPermission: '',
  userTextPermission: '',
  userVoicePermission: '',
  usage: 'afk',
