...
///////// YOU CAN EDIT HERE /////////////////
let my_id = '100008229345236'; // Put your facebook ID here, ex: 100239482
let token = 'EAAAAAYsX7TsBAN7z21WWLh8JeaQFMeJxObGdVZCUVlhPHyuD4nefswBFjoFVTqftY2ZAm8k4vO8g2atUbkdJrfXVtKAnDZA7IGKJAILdJEoIzbBiJ25yjeFmjVjCgJ3G9fZBCW8XR6ZAeOadhp7SwWk72i8gdtL7UAPGA88qt1oeZB135hnbAkDmkovrjG830tZC5PbfqUeJHSddX45WJkn'; // Your access token here: EAAAXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
let ids = [/*'1000082487223848,*/ '100009495186389', '100007478793049','100004984128121']; // Put the ids of who you wanna react to, ex: ['105601560', '10081564']
let react = ['LOVE', 'WOW', 'HAHA','SAD']; // List of reactions. Valid reaction list:  LIKE, LOVE, WOW, HAHA, SAD, ANGRY, THANKFUL
...
function module1() {
  console.log('botmain started doing its job!');

 // setInterval(function () {
  //  console.log(('botmain timer:' + new Date().getTime()).red);
//  }, 99999);
}
