...
exports.exec = async(Bastion, message, args) => {
  try {
    ...
    let voiceConnection = message.guild.voiceConnection,
      voiceChannel, textChannel, vcStats;
...
exports.help = {
  name: 'play',
  description: 'Plays a song or adds the song to the current music queue if Kara is already playing in your Discord server, specified either by the name, or the link, or from your favorite songs list, or from a YouTube playlist link.',
  botPermission: '',
  userTextPermission: '',
  userVoicePermission: '',
 ...
 * @param {VoiceConnection} connection the VoiceConnection of Kara in this guild
 * @returns {void}
 */
