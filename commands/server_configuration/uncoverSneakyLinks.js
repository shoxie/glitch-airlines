...
exports.help = {
  ...
  description: 'Toggle uncovering of sneaky links in the messages sent in the server. If enabled, Kara will show details of all link that contains redirects to other locations, in every message sent in the server.',
  botPermission: '',
